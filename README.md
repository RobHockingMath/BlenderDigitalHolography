...
If you already have a blender screen, load and run the "create_hogel_lightfield_rig.py" script to add the hogel images rendering rig into the scene.  You may want to take a look at hogel_params.py and adapt it to your setup.
